package com.eeg.components.graphs;
...
import com.eeg.components.csv.EEGFileReader;
import com.eeg.components.csv.EEGFileWriter;
import com.eeg.components.signal.CircularBufferRead;
import com.eeg.components.signal.Filter;
...
public class EEGLive extends FrameLayout {
    ...
    public CircularBufferRead eegBuffer = new CircularBufferRead(220, 4);
    ...
    // ------------------------------------------------------------------------
    // Constructors
    public EEGLive(Context context) {
        super(context);
    ...
    // Initializes and styles the AndroidPlot XYPlot component of EEGLive
    ...
    private final class OfflineDataListener implements Runnable {
        ...
        OfflineDataListener(String offlineData) {
            ...
            } catch (IOException e) { Log.w("EEGLive", "File not found error"); }
        }
        ...
        public void run() {
            try {
                ...
                Log.w("EEGLive", "interrupted exception");
            }
        }
